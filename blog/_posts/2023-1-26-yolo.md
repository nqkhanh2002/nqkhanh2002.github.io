...
{% include image.html url="blog/images/less5/yologo_2.png" description="" %}
...
{%include image.html url="blog/images/less5/yolo_evolution.webp" description="Sự phát triển các phiên bản của YOLO theo thời gian" %}
...
{% include image.html url="blog/images/less5/yolov1.png" description="Kiến trúc mạng YOLO v1" %}
...
{% include image.html url="blog/images/less5/yolo-v1-predictions.webp" description="YOLO version 1 conceptual design (Source: You Only Look Once: Unified, Real-Time Object Detection by Joseph Redmon et al.)" %}
...
{% include image.html url="blog/images/less5/non-max-supperession.webp" description="Non Max Suppression" %}
...
{% include image.html url="blog/images/less5/IoU.webp" description="" %}
...
{% include image.html url="blog/images/less5/yolov2.jpg" description="Kiến trúc mạng YOLO v2" %}
...
{% include image.html url="blog/images/less5/anchor.webp" description="Tính toán anchor box - ResearchGate. Như vậy, thay vì predict trực tiếp (x,y,w,h), ta predict ra bộ offset - tức độ lệch giữa groundtruth_bbox với các anchor box." %}
...
{% include image.html url="blog/images/less5/yolo-v2-architecture.webp" description="YOLOv2 kết hợp các feature map ở các tầng khác nhau" %}
...
{% include image.html url="blog/images/less5/yolo-v2-reorg.webp" description="" %}
...
{% include image.html url="blog/images/less5/yolo-9k-word-tree.webp" description="WordTree" %}
# 4. YOLO v3 (2018)
